...
import { InactivateComboUseCase } from '@scoops/core/pdv/use-cases'
...
type RequestBody = Omit<
  Parameters<InactivateComboUseCase['execute']>[0],
  'actor' | 'comboId'
>

@DiscountsController()
export class InactivateComboController {
  private readonly useCase: InactivateComboUseCase
  ...
  constructor(
    ...
    this.useCase = new InactivateComboUseCase(database, catalog, broker)
  }

  @Patch(':discountId/inactivate')
  @RequiredProfiles([UserProfile.Manager])
  @ApiParam({
    name: 'discountId',
    format: 'uuid',
    description: 'The Combo to inactivate.',
  })
  @ApiResponse({
    status: HttpStatus.OK,
    description: 'Combo inactivated.',
  ...
  @ApiResponse({
    ...
    description: 'The authenticated profile cannot inactivate Combos.',
    type: ErrorResponseDto,
  })
  @ApiResponse({
