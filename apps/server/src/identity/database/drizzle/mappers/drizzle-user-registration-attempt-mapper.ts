...
export class DrizzleUserRegistrationAttemptMapper {
  static toDomain(record: DrizzleUserRegistrationAttempt): UserRegistrationAttempt {
    return {
      ...
      operationToken: record.operationToken ?? undefined,
      operationClaimedAt: record.operationClaimedAt ?? undefined,
      pendingEmail: record.pendingEmail ?? undefined,
      pendingTokenHash: record.pendingTokenHash ?? undefined,
      pendingExpiresAt: record.pendingExpiresAt ?? undefined,
