...
export function useOrdersPage({ onSearchChange, search }: OrdersPageProps) {
  ...
  return {
    ...
    isPageLoadingOrders: ordersQuery.isPageLoadingOrders,
    isRefreshingChannels: channelsQuery.isRefreshingSalesChannels,
    isRefreshingOrders: ordersQuery.isRefreshingOrders,
