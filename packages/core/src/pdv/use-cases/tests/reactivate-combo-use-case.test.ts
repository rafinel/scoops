...
describe('ReactivateComboUseCase', () => {
  ...
  it('rejects non-manager actors before infrastructure access', async () => {
    const useCase = new ReactivateComboUseCase(database, catalog, broker)
    await expect(
