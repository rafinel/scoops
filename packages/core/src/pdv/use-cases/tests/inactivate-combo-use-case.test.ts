...
describe('InactivateComboUseCase', () => {
  ...
  it('rejects non-manager actors before infrastructure access', async () => {
    const useCase = new InactivateComboUseCase(database, catalog, broker)
    await expect(
