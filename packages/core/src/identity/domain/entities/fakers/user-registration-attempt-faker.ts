...
export class UserRegistrationAttemptFaker {
  static fake(overrides: Partial<UserRegistrationAttempt> = {}): UserRegistrationAttempt {
  ...
  static fakeMany(count = 10): UserRegistrationAttempt[] {
    return Array.from({ length: count }, () => UserRegistrationAttemptFaker.fake())
  }
}
