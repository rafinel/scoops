...
- **Rules:** `documentation/sdd.md` (Plan ownership, living evidence, Reviewer lifecycle and handoff); the complete Rule Pack recorded in [`spec.md`](./spec.md); `documentation/architecture.md`; `documentation/modules.md`; `documentation/design.md`; `documentation/tooling.md`; [`documentation/agents/implementation-reviewer-agent.md`](../../../agents/implementation-reviewer-agent.md); `AGENTS.md` (service health, Playwright CLI, screenshots, console/network inspection and process cleanup). No selected Rule file contains an `Antipatterns to Avoid` subsection.
...
| Review | One complete integrated candidate, cross-Builder contracts and all affected surfaces | `RF-01`–`RF-08`, `CA-01`–`CA-12` | [`Integrated Reviewer`](../../../agents/implementation-reviewer-agent.md) | One Reviewer report plus Orchestrator-verified findings in `./evaluation.md` | `passed` |
