...
| `FND-004` | Implementation dependency | F5-T1 web type/render after generated dynamic route | `EV-WEB`; `CA-01` | `resolved` | F5-T2 supplied `ProductStockSlot`; route generation, types and browser suites pass |
