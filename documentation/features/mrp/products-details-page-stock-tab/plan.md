...
- **Paths:** `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/index.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/use-product-stock-slot.ts`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-stock-header/**`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-stock-summary/**`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-brands-card/index.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-brands-card/use-product-brands-card.ts`.
...
- **Exit:** Run `pnpm exec biome check apps/web/src/ui/mrp/widgets/slots/product-stock-slot`; with Playwright CLI compare the exact tree to `bi8Au.png` and applicable 320 × 900 states, exercise keyboard/focus/overflow, inspect console/failed requests, and save fresh populated/loading/error/empty captures.
...
- **Paths:** `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-brands-card/product-brand-actions-menu/index.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-brand-dialog/index.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-brand-dialog/use-product-brand-dialog.ts`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/remove-product-brand-dialog/index.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/remove-product-brand-dialog/use-remove-product-brand-dialog.ts`.
...
- **Exit:** Run `pnpm exec biome check apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-brand-dialog apps/web/src/ui/mrp/widgets/slots/product-stock-slot/remove-product-brand-dialog apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-brands-card/product-brand-actions-menu`; with Playwright CLI compare exact trees independently to the four references, exercise keyboard/Escape/focus/pending/error/narrow states, inspect console/failed requests, and save each fresh capture.
...
- **Paths:** `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/stock-adjustment-dialog/index.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/stock-adjustment-dialog/use-stock-adjustment-dialog.ts`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/stock-transaction-history-card/index.tsx`.
...
- **Paths:** `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-stock-slot.test.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/use-product-stock-slot.test.ts`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/product-brand-dialog/product-brand-dialog.test.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/stock-adjustment-dialog/stock-adjustment-dialog.test.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/remove-product-brand-dialog/remove-product-brand-dialog.test.tsx`, `apps/web/src/ui/mrp/widgets/slots/product-stock-slot/stock-transaction-history-card/stock-transaction-history-card.test.tsx`.
