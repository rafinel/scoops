...
- **Rules:** `documentation/sdd-rules.md` (living evidence, Plan ownership and Reviewer lifecycle); the complete Rule Pack recorded in [`spec.md`](./spec.md); `documentation/architecture.md`; `documentation/modules.md`; `documentation/design.md`; `documentation/tooling.md`; [`documentation/agents/reviewer-agent.md`](../../../agents/reviewer-agent.md).
...
| Review | One complete integrated candidate, cross-Builder contracts and all affected surfaces | `RF-01`–`RF-12`, `CA-01`–`CA-14` | [`reviewer-agent.md`](../../../agents/reviewer-agent.md) | One Integrated Reviewer report plus Orchestrator-verified findings in `./evaluation.md` | `passed` |
